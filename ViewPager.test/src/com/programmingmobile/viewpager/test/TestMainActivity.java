...
public class TestMainActivity extends ActivityInstrumentationTestCase2<MainActivity>
{
	...
	//DIALOG MESSAGES
	private final String UserAndPwDialog   = "User: ";
	private final String onlyUserDialog    = "Please enter the \"Password\".";
	private final String onlyPwDialog      = "Please enter the \"User Name\".";
	private final String nothingDialog 	   = "Please enter a \"User Name\" and its \"Password\".";
